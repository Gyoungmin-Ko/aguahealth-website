export const aiModules = [
  ...
  },
  {
    ...
    tagline: '퇴장방지의약품 원가산정방식을 적용해 원가를 보전합니다. 제품(국내제조)과 상품(수입의약품)을 구분해 산정합니다.',
    // 제품/상품 구분 후 각각 입력·계산 적용
    productTypeOptions: [
      { value: 'product', label: '제품 (국내제조)' },
      { value: 'commodity', label: '상품 (수입의약품)' },
    ],
    inputs: [
      { id: 'productType', label: '구분', type: 'select', options: [{ value: 'product', label: '제품 (국내제조)' }, { value: 'commodity', label: '상품 (수입의약품)' }], placeholder: '제품 또는 상품 선택' },
      { id: 'productName', label: '제품/상품명', type: 'text', placeholder: '예: 모비졸로정 1mg' },
      { id: 'companyName', label: '업소명', type: 'text', placeholder: '예: (주)한국팜비오' },
      { id: 'drugCode', label: '약가코드', type: 'text', placeholder: '예: 659901440' },
      { id: 'unitSpec', label: '규격단위', type: 'text', placeholder: '예: 300정, 1병' },
      { id: 'targetTiming', label: '지정 희망 시점', type: 'text', placeholder: '예: 2026년 상반기' },
      // 제품(국내제조) 전용 - 1규격단위당 원가 항목 (원)
      { id: 'annualProduction', label: '연간 총생산량(규격단위)', type: 'text', placeholder: '예: 13510500', showWhen: 'product' },
      { id: 'rawMaterialPerUnit', label: '1단위당 원료비(원)', type: 'text', placeholder: '예: 3.5', showWhen: 'product' },
      { id: 'materialPerUnit', label: '1단위당 재료비(원)', type: 'text', placeholder: '예: 0.8', showWhen: 'product' },
      { id: 'laborPerUnit', label: '1단위당 노무비(원)', type: 'text', placeholder: '예: 2.1', showWhen: 'product' },
      { id: 'overheadPerUnit', label: '1단위당 제조경비(원)', type: 'text', placeholder: '예: 1.2', showWhen: 'product' },
      { id: 'sellingAdminPerUnit', label: '1단위당 판매 및 일반관리비(원)', type: 'text', placeholder: '예: 1.0', showWhen: 'product' },
      { id: 'nonOperatingPerUnit', label: '1단위당 영업외 손익(원)', type: 'text', placeholder: '예: -0.05', showWhen: 'product' },
      { id: 'profitRatePercent', label: '적정이윤률(%)', type: 'text', placeholder: '예: 10.712', showWhen: 'product' },
      // 상품(수입의약품) 전용 - 추후 표60·별지5 반영
      { id: 'purchasePricePerUnit', label: '1단위당 매입원가(원)', type: 'text', placeholder: '예: 50', showWhen: 'commodity' },
      { id: 'commoditySellingAdminPerUnit', label: '1단위당 판매 및 일반관리비(원)', type: 'text', placeholder: '예: 5', showWhen: 'commodity' },
      { id: 'commodityProfitRatePercent', label: '적정이윤률(%)', type: 'text', placeholder: '예: 10.712', showWhen: 'commodity' },
      // 공통
      { id: 'costData', label: '원가자료(첨부)', type: 'file', accept: '.pdf,.xlsx,.xls,.csv', description: '원가산정 관련 서류 (선택)', showWhen: null },
      { id: 'notes', label: '추가 메모', type: 'textarea', placeholder: '가정/제약사항/특이사항', showWhen: null },
    ],
    outputs: [
      '퇴장방지의약품 원가산정 결과 요약',
      '원가산정 방식·근거 요약',
